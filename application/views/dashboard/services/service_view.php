                    ...
                    <table class="table table-border">
                         ...
                         foreach ($products as $product) : $i++; ?>
                              <tr>
                                   ...
                                   <td>
                                        <a href="<?= base_url() ?>dashboard/services/item/<?= $product->service_id ?>" class="btn btn-primary mt-2"><i class="fa fa-eye"></i></a>
                                        <a href="<?= base_url() ?>dashboard/services/edit/<?= $product->service_id ?>" class="btn btn-info mt-2"><i class="fa fa-pencil"></i></a>
                                        <button data-toggle="modal" data-target="#confirm-modal" data-toggle="modal" data-target="#confirm-modal" data-id="<?= $product->service_id ?>" class="btn btn-danger delete mt-2"><i class="fa fa-trash"></i></button>
                                   </td>
                              </tr>
                         <?php endforeach; ?>
                    </table>
