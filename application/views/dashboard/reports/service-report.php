     ...
     <div class="content-wrapper container-fluid relative animatedParent animateOnce p-lg-5">
          ...
          <div class="bg-white p-3">
               <div class="col-sm-12 mb-5 mt-5">
                    <form action="" id="service-filter" method="POST">
                         <div class="row">
...
<script>
     $(document).ready(function() {
          ...
          $(document).on("submit", "#service-filter", function(e) {
               e.preventDefault();
               var formdata = $(this).serializeArray();
               console.log(formdata);
               var html = customer = service = mobile = email = status = item_name =  "";
               $(".serviceTable tbody").html("");
               $.ajax({
                    method: "post",
                    url: "<?= base_url() ?>ajax/servicefilter",
                    data: formdata,
                    success: function(status) {
                         ...
                         $.each(results.customer_item, function(k1, ci) {
                              ...
                              $.each(results.items,function(k4,i){
                                   ...
                                   $.each(results.service, function(k3, s) {
