...
<div class="card bg-light">
     <div class="card-header">
          <h4 class="text-center">Edit Customer Item</h4>     
     </div>
     ...
     <div class="row">
          ...
          <div class="form-group exist-customers col-sm-6">
               ...
               <select name="product_id" id="" class="form-control select-product">
     ...
     $(".select-product").change(function(){
         var product_id = $(this).find(":selected").val();
          $.ajax({
               ...
               var html = '<div class="form-group exist-customers col-sm-2"><input type="checkbox" data-id="'+value["item_id"]+'" name="customeritem[]" value="'+value["item_id"]+'" class="customeritem item_'+value["item_id"]+'"> '+value["item_name"]+'</div>';
