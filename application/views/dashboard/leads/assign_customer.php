          ...
          <div class="tab-content bg-white p-3" id="pills-tabContent">
               ...
               <div class="tab-pane fade bg-white p-3" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                         ...
                         <li class="nav-item">
                              <a class="nav-link sub-nav-tabs pills-create-quotation-tab" id="pills-create-quotation-tab" data-toggle="pill" href="#pills-create-quotation" role="tab" aria-controls="pills-create-quotation" aria-selected="true">Generate Quotation</a>
                         </li>
                    </ul>
                    <div class="tab-content bg-white p-3" id="pills-tabContent">
...
<script>
     ...
     $(document).ready(function() {
          ...
          if (localStorage.getItem("subtabs")) {
               var subtabs = localStorage.getItem("subtabs");
               if (subtabs == $(subtabs + "-tab").attr("href")) {
