            ...
            <aside class="main-sidebar fixed offcanvas b-r" data-toggle='offcanvas'>
                  <section class="sidebar">
                        <ul class="sidebar-menu mt-4">
                              ...
                              <li class="treeview <?= ($this->uri->uri_string() == "dashboard/customize_report" || $this->uri->uri_string() == "dashboard/customize_report_fields" || $this->uri->uri_string() == "dashboard/report/leads" || $this->uri->uri_string() == "dashboard/report/quotation" || $this->uri->uri_string() == "dashboard/report/product" || $this->uri->uri_string() == "dashboard/report/service") ? "active" : "" ?>"><a  class="" href="#">
                                          <i class="icon icon-report text-red s-24"></i>
                                          <span>Reports</span>
                                          <i class=" icon-angle-left  pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">
                                          <li><a  class="<?= ($this->uri->uri_string() == "dashboard/report/leads") ? "active" : "" ?>" href="<?= base_url() ?>dashboard/report/leads"><i class="icon icon-clipboard2"></i>Lead Reports</a>
                                          </li>
                                          <li><a  class="<?= ($this->uri->uri_string() == "dashboard/report/product") ? "active" : "" ?>" href="<?= base_url() ?>dashboard/report/product"><i class="icon icon-package"></i>Product Reports</a>
                                          </li>
                                          <li><a  class="<?= ($this->uri->uri_string() == "dashboard/report/service") ? "active" : "" ?>" href="<?= base_url() ?>dashboard/report/service"><i class="icon icon-package"></i>Service Reports</a>
                                          </li>
                                          <li><a  class="<?= ($this->uri->uri_string() == "dashboard/report/quotation") ? "active" : "" ?>" href="<?= base_url() ?>dashboard/report/quotation"><i class="icon icon-clipboard2"></i>Quotation Reports</a>
                                          </li>
                                    </ul>
                              </li>
                              ...
                              <li class="treeview"><a  class="" href="<?= base_url()?>logout"><i class="icon icon-lock-open light-green-red s-24"></i>Logout</a>
                              </li>
            ...
            <div class="sticky">
                  <div class="navbar navbar-expand d-flex justify-content-between bd-navbar white b-b">
                        <div class="relative">
                              <div class="d-flex">
                                    <div>
                                          <a  class="" href="#" data-toggle="push-menu" class="paper-nav-toggle pp-nav-toggle">
                                                <i></i>
                                          </a>
                                    </div>
                                    <ul class="nav responsive-tab nav-material nav-material-white mt-1 ml-3" id="v-pills-tab">
                                          <li>
                                                <a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="javascript:void(0)"><i class="icon icon-calendar"></i>
                        ...
                        <div class="navbar-custom-menu d-flex align-items-center">
                              <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown custom-dropdown notifications-menu">
                                          <a  class="" href="#" class="nav-link  b-r b-l pl-lg-3 pr-lg-3" data-toggle="dropdown" aria-expanded="false">
                                          ...
                                          <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li class="footer p-2 text-center"><a  class="" href="#">View all</a></li>
                                          </ul>
                                    </li>
                              ...
                              <!-- Button -->
                              <div>
                                    <a  class="" href="<?= base_url()?>logout" class="btn btn-primary btn-sm ml-3 d-none d-sm-block">Sign Out</a>
                              </div>
                        </div>
